...
export default function ImageElement({
  ...
  return (
    ...
    >
      {element.isDynamic && !element.src ? (
        <div className="w-full h-full flex items-center justify-center border-2 border-dashed border-green-400 bg-green-50 rounded">
          <div className="text-center text-green-600 text-xs pointer-events-none">
