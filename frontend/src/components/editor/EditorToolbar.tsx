  ...
  return (
    <div className="bg-white border-b border-border px-4 py-2 flex items-center gap-2 flex-wrap">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-green-50 border border-green-200 transition-colors"
        title="商品画像枠を追加（商品ごとに異なる画像を設定可能）"
      >
        <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v3m0 0v3m0-3h3m-3 0H9" />
        </svg>
        <span className="text-sm text-green-700">商品画像</span>
      </button>
